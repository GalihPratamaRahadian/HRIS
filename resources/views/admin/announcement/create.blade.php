			...
			<div class="card-body">
				...
				<form id="mainForm">
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="content" rows="3" placeholder="Masukkan konten"></textarea>
						<span class="invalid-feedback"></span>
					</div>
					...
					<div class="form-group">
						<label> Kirim Broadcast Pengumuman Via Whatsapp </label>
						<p class="text-muted small">
							* Tidak Akan Terkirim Jika Status Publikasi Bernilai Draft <br>
							* Broadcast Akan Dilakukan 2 Menit Setelah Pengumuman Di Simpan
						</p>

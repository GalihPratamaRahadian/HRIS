			...
			<div class="card-body">
				...
				<form id="mainForm">
					...
					<div class="form-group">
						...
						<input type="text" name="name" class="form-control" placeholder="Nama" value="{{ $employeeFamily->name }}" required>
					...
					<div class="form-group">
						...
						<input type="text" name="place_of_birth" class="form-control" placeholder="Tempat Lahir" value="{{ $employeeFamily->place_of_birth }}" required>
						<span class="invalid-feedback"></span>
					</div>

					<div class="form-group">
						<label> Tanggal Lahir {!! Template::required() !!} </label>
						<input type="date" name="date_of_birth" class="form-control" max="{{ date('Y-m-d') }}" value="{{ $employeeFamily->date_of_birth }}" required>
						<span class="invalid-feedback"></span>
					</div>
...
<script type="text/javascript">
	$(function(){
		...
		$form.find(`[name="relationship_status"]`).val(`{{ $employeeFamily->relationship_status }}`).trigger('change')
	});
</script>
@endsection
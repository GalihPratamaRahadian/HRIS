			...
			<div class="card-body">
				...
				<form id="mainForm">
					...
					<div class="form-group">
						...
						<input type="date" name="start_date" class="form-control" placeholder="Awal Kontrak" required>
						<span class="invalid-feedback"></span>
					</div>

					<div class="form-group">
						<label> Akhir Kontrak {!! $wajibDiisi !!} </label>
						<input type="date" name="end_date" class="form-control" placeholder="Akhir Kontrak" required>
						<span class="invalid-feedback"></span>
					</div>
...
<script type="text/javascript">
	$(function(){
		...
		$form.on('submit', function(e){
			...
			ajaxSetup();
			$.ajax({
				url : `{{ route('employee_contract.store') }}`,
				method : 'post',
				data : formData,
				dataType : 'json',
			})

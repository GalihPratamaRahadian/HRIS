				...
				<form id="mainForm">
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="basic_salary" class="form-control" placeholder="Gaji Pokok" value="0" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="overtime_pay" class="form-control" placeholder="Upah Lembur Per Jam" value="0" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="daily_meal_allowance" class="form-control" placeholder="Tunjangan Makan Harian" value="0" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="daily_transportation_allowance" class="form-control" placeholder="Tunjangan Transportasi Harian" value="0" required>
                        </div>
                    </div>
...
<script type="text/html" id="allowanceTemplate">
	<tr>
		...
		<td>
			<input type="number" name="allowance_nominal[]" class="form-control" placeholder="Nominal Tunjangan" value="0" required>
		</td>
		<td>
...
<script type="text/html" id="cutTemplate">
	<tr>
		...
		<td>
			<input type="number" name="cut_nominal[]" class="form-control" placeholder="Nominal Potongan" value="0" required>
		</td>
		<td>
			<button type="button" class="btn btn-danger removeBtn p-1">
				<i class="mdi mdi-close m-0"> </i>
...
<script type="text/javascript">
	$(function(){
		...
		$form.on('submit', function(e){
			...
			ajaxSetup();
			$.ajax({
				url : `{{ route('employee_salary.store') }}`,
				method : 'post',
				data : formData,
				dataType : 'json',
			})

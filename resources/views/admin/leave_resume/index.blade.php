			...
			<div class="card-body">
				...
				<form id="mainForm">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="form-group start-working" style="display: none;">
								<label> Tanggal Mulai Kerja - <b class="employee-name"></b> </label>
								<input type="text" class="form-control start-working-date" readonly>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	$(function(){
		...
		$form.on('submit', function(e) {
			...
			window.open(`{{ route('admin.leave_resume.generate') }}?${formData}`, '_blank')
		})

...
@section('action')
@if(UserPermission::check('necessity_reason', 'c'))
<a href="{{ route('admin.necessity_reason.create') }}" class="btn btn-success">
...
<script type="text/javascript">
	$(function(){
		...
		$('#dataTable').DataTable({
			...
			autoWidth : false,
			ajax : {
				url : "{{ route('admin.necessity_reason') }}"
			},
			columns : [
				{
					data : "reason",
				...
				{
					data : "is_counted_present",
					name : 'is_counted_present'
				},
				{

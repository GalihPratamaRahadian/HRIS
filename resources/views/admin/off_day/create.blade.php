			...
			<div class="card support-pane-card">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" name="off_day_name" class="form-control" placeholder="Nama Hari Libur" required>
						<span class="invalid-feedback"></span>
					</div>

					<div class="form-group">
						<label> Awal Libur {!! Template::required() !!} </label>
						<input type="date" name="start_date" class="form-control" placeholder="Awal Libur" required>
						<span class="invalid-feedback"></span>
					</div>

					<div class="form-group">
						<label> Akhir Libur {!! Template::required() !!} </label>
						<input type="date" name="end_date" class="form-control" placeholder="Akhir Libur" required>
						<span class="invalid-feedback"></span>
					</div>

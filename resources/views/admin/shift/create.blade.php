			...
			<div class="card support-pane-card">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" name="shift_name" class="form-control" placeholder="Nama Jam Kerja" required>
						<span class="invalid-feedback"></span>
					</div>

					<div class="form-group">
						<label> Batas Jam Awal Kehadiran {!! Template::required() !!} </label>
						<input type="text" name="clock_start_limit" class="form-control" placeholder="Batas Jam Awal Kehadiran" autocomplete="off" required>
						<span class="invalid-feedback"></span>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="clock_start" class="form-control" placeholder="Jam Mulai" autocomplete="off" required>
								<span class="invalid-feedback"></span>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="clock_end" class="form-control" placeholder="Jam Selesai" autocomplete="off" required>
								<span class="invalid-feedback"></span>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<input type="number" name="late_tolerance" class="form-control" placeholder="Toleransi Keterlambatan" value="0">
						<span class="invalid-feedback"></span>
					</div>
					...
					<div class="form-group">
						...
						<div class="custom-control custom-checkbox ml-2">
							<input type="checkbox" class="custom-control-input" name="offday_shift[]" value="1" id="addSenin">
							<label class="custom-control-label pt-1" for="addSenin"> Senin </label>
						</div>
						<div class="custom-control custom-checkbox ml-2">
							<input type="checkbox" class="custom-control-input" name="offday_shift[]" value="2" id="addSelasa">
							<label class="custom-control-label pt-1" for="addSelasa"> Selasa </label>
						</div>
						<div class="custom-control custom-checkbox ml-2">
							<input type="checkbox" class="custom-control-input" name="offday_shift[]" value="3" id="addRabu">
							<label class="custom-control-label pt-1" for="addRabu"> Rabu </label>
						</div>
						<div class="custom-control custom-checkbox ml-2">
							<input type="checkbox" class="custom-control-input" name="offday_shift[]" value="4" id="addKamis">
							<label class="custom-control-label pt-1" for="addKamis"> Kamis </label>
						</div>
						<div class="custom-control custom-checkbox ml-2">
							<input type="checkbox" class="custom-control-input" name="offday_shift[]" value="5" id="addJumat">
							<label class="custom-control-label pt-1" for="addJumat"> Jum'at </label>
						</div>
						<div class="custom-control custom-checkbox ml-2">
							<input type="checkbox" class="custom-control-input" name="offday_shift[]" value="6" id="addSabtu">
							<label class="custom-control-label pt-1" for="addSabtu"> Sabtu </label>
						</div>
						<div class="custom-control custom-checkbox ml-2">
							<input type="checkbox" class="custom-control-input" name="offday_shift[]" value="7" id="addMinggu">
...
<script type="text/html" id="shiftDetailTemplate">
	<tr class="shiftDetailItem">
		...
		<td>
			<input type="text" name="shift_detail_clock_start[]" class="form-control clock-start" placeholder="Jam Mulai" autocomplete="off" required>
		</td>
		<td>
			<input type="text" name="shift_detail_clock_end[]" class="form-control clock-end" placeholder="Jam Selesai" autocomplete="off" required>
		</td>
		<td>

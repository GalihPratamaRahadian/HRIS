		...
		<div class="card support-pane-card">
			<div class="card-body">
				...
				<form id="form">
					...
					<div class="form-group">
						<label> Persetujuan Sakit/Izin {!! \Setting::required() !!} </label>
...
<script type="text/javascript">
	$(function(){
		...
		$form.on('submit', function(e){
			...
			ajaxSetup();
			$.ajax({
				url : `{{ route('admin.sick_necessity_submission.store') }}`,
				method : 'post',
				data : formData,
				dataType : 'json',
				contentType : false,
			...
			.done(response => {
				...
				setTimeout(() => {
					window.location.href = `{{ route('admin.sick_necessity_submission') }}`
				}, 1000)
			})
			.fail(error => {

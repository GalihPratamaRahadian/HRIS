...
@section('action')
<button class="btn btn-success filterBtn">
	<i class="mdi mdi-filter"></i> Filter
</button>
@if(UserPermission::check('sick_necessity_submission', 'c'))
<a class="btn btn-primary" href="{{ route('admin.sick_necessity_submission.create') }}">
...
<div class="alert alert-primary">
	Ada {{ $pending }} pengajuan izin/sakit menunggu persetujuan. <a href="{{ route('admin.sick_necessity_submission') }}?status=wait"> Klik disini </a> untuk melihat.
</div>
@endif
...
<script type="text/javascript">
	$(function(){
		...
		$('#dataTable').DataTable({
			...
			autoWidth : false,
			ajax : {
				url : "{{ route('admin.sick_necessity_submission') }}"
			},
			columns : [
				{
					data : 'created_at',
			...
			preDrawCallback : settings => {
				...
				settings.ajax.url = `{{ route('admin.sick_necessity_submission') }}?status=${status}`;
			},

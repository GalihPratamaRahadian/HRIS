			...
			<div class="card-body">
				...
				<form id="mainForm">
					...
					<div class="form-group">
						...
						<input type="text" name="location_name" class="form-control" placeholder="Nama Lokasi" required>
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="address" placeholder="Alamat (Opsional)" rows="3"></textarea>
						<span class="invalid-feedback"></span>
					</div>

					<div class="form-group">
						<label> Deskripsi (Opsional) </label>
						<textarea class="form-control" name="description" placeholder="Deskripsi (Opsional)" rows="3"></textarea>
						<span class="invalid-feedback"></span>
					</div>
...
<script type="text/javascript">
	$(function(){
		...
		$form.on('submit', function(e){
			...
			ajaxSetup();
			$.ajax({
				url : `{{ route('admin.tracking_location.store') }}`,
				method : 'post',
				data : formData,
				dataType : 'json',
				processData: false,

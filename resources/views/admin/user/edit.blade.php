		...
		<div class="col-md-6">
			<div class="card support-pane-card">
				<div class="card-body">
					...
					<div class="form-group">
						<label> Konfirmasi Password (Isi Jika Ingin Ganti Password) </label>
...
<script type="text/javascript">
	$(function(){
		...
		$form.find(`[name="is_restricted_access"]`).val(`{{ $user->is_restricted_access }}`).trigger('change')

		@foreach($user->userPermissions as $permission)
		setUserPermission(`{{ $permission->menu }}`, `{{ $permission->access_allowed }}`)
		@endforeach

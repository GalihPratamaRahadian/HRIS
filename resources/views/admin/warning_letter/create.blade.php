		...
		<div class="card support-pane-card">
			<div class="card-body">
				...
				<form id="mainForm">
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="date" name="start_date" class="form-control" placeholder="Jangka Waktu Awal" required>
								<span class="invalid-feedback"></span>
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="date" name="end_date" class="form-control" placeholder="Jangka Waktu Akhir" required>
								<span class="invalid-feedback"></span>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<label> Pesan </label>
						<textarea class="form-control" name="message" rows="4" placeholder="Pesan"></textarea>
						<span class="invalid-feedback"></span>
					</div>
...
<script type="text/javascript">
	$(function(){
		...
		const init = () => {
			resetForm();
			$form.find(`[name="id_employee"], [name="type"]`).val('').trigger('change')
		}
		...
		$form.on('submit', function(e){
			...
			ajaxSetup();
			$.ajax({
				url : `{{ route('warning_letter.store') }}`,
				method : 'post',
				data : formData,
				dataType : 'json',
			})

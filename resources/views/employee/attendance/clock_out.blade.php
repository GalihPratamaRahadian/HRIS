...
@section('script')
<script src="https://maps.googleapis.com/maps/api/js?key={{ \Setting::getValue('google_geolocation_api_key') }}"></script>
	...
	$(function(){
		...
		const attendanceSubmit = () => {
			$('#attendanceForm').on('submit', function(e){
				...
				ajaxSetup();
				$.ajax({
					url : `{{ isset($_GET['for_overtime']) ? route('attendance.store_clock_out', [ 'for_overtime' => $_GET['for_overtime'] ]) : route('attendance.store_clock_out') }}`,
					method : 'post',
					data : formData,
					dataType : 'json',
				})

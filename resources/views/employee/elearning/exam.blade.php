...
<div class="row">
		...
		<div class="border p-4 mb-3">
			...
			<div class="row">
				...
				<div class="col-lg-5">
					...
					@else
					<a href="{{ route('employee.elearning.exam_answers', $course->id) }}" class="btn btn-outline-success btn-block mb-2">
	...
	<div class="col-md-4">
		...
		<a href="{{ route('employee.elearning.exam_answers', $course->id) }}" class="btn btn-inverse-primary btn-block">
			Lihat Semua Jawaban
		</a>
	</div>
</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('.answer-item').on('click', function(){
			...
			ajaxSetup()
			$.ajax({
				url: `{{ route('employee.elearning.set_answer', $question->question->id) }}`,
				method: 'post',
				dataType: 'json',
				data: {

...
<li class="nav-item">
	...
	<div class="collapse" id="hariLiburItem">
		<ul class="nav flex-column sub-menu">
			...
			<li class="nav-item">
				<a class="nav-link" href="{{ route('admin.overtime_submission') }}"> Pengajuan Lembur </a>
			</li>
			@endif
			...
			@endif
			@if(UserPermission::check('overtime_resume', 'r'))
			<li class="nav-item">
				<a class="nav-link" href="{{ route('admin.overtime_resume') }}"> Buat Rekap Lembur </a>
			</li>
			@endif
			@if (UserPermission::check('sick_necessity_resume', 'r'))
			<li class="nav-item">
				<a class="nav-link" href="{{ route('admin.sick_necessity_resume') }}"> Buat Rekap Izin / Sakit </a>
			</li>
			@endif
		</ul>
	</div>
...
<li class="nav-item">
	<a class="nav-link" href="{{ route('face_terminal_log') }}">
		<i class="menu-icon mdi mdi-account-group"></i>
...
@if(UserPermission::check('face_compare', 'r') || UserPermission::check('send_message_to_employee', 'r') || UserPermission::check('mobile_app_notification', 'r'))
<li class="nav-item">
	...
	<div class="collapse" id="advance-item">
		<ul class="nav flex-column sub-menu">
			...
			@endif
			@if(UserPermission::check('mobile_app_notification', 'r'))
			<li class="nav-item">
				<a class="nav-link" href="{{ route('admin.mobile_app_notification') }}"> Notifikasi Mobile App </a>
			</li>
			@endif
		</ul>
	</div>
...
<li class="nav-item">
	...
	<div class="collapse" id="system-item">
		<ul class="nav flex-column sub-menu">
            ...
            <li class="nav-item">
				<a class="nav-link" href="{{ route('setting.email') }}"> Edit Email </a>
			</li>
            <li class="nav-item">
				<a class="nav-link" href="{{ route('setting.whatsapp') }}"> Scan QR Code Whatsapp </a>
			</li>
			<li class="nav-item">

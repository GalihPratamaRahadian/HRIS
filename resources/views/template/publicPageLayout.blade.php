...
<head>
	...
	<?php 
		$backgroundLink = Setting::getLoginBackgroundLink(false);
		$backgroundBlur = 'blur(' . Setting::getValue('background_blur', 0) .'px)';
	?>
...
<body>
	<div class="container-scroller">
		<div class="container-fluid page-body-wrapper full-page-wrapper auth-bg">
